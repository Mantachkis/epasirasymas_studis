...
class Studijas extends Eloquent
{
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasOne
     */
    public function studijasProgramma()
    {
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasOne
     */
    public function studijasStudTekStav()
    {
        return $this->hasOne('App\Models\Luadm\Tips', 'tkods', 'stud_tek_stav');
    }

    public function studijasTipsFinanses()
    {
    ...
    public function getGradesByStudyType(){
        ...
        return DB::selectOne('select esp.esp_api.get_VDU_marks(p_studkods_in => :p_studkods_in, p_type_in => :p_type_in) as grade from dual', $binds);
    }
}