...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'epasirasymas' => [
            'driver'     => 'sftp',
            'host'       => env('SERVER_HOST', 'sftp.example.com'),
            'port'       => 22,
            'username'   => env('SERVER_USERNAME', 'your-username'),
            'password'   => env('SERVER_PASSWORD', 'your-password'),
            // 'privateKey' => 'path/to/or/contents/of/privatekey',
            'root'       => '/home/epasirasymas/public_html1/',
            // 'timeout'    => 20,
            // 'visibility' => 'public',
            // 'pirate'     => false,
            // 'eventable'  => true,
